...
<body>
	<article class="container">
		...
		<div class="col-md-6 col-md-offset-3">
			<form action="/ex/member/modifyMember.do" method="post" name="reg_frm">
				...
				<div class="form-group">
					<label for="userName">이름</label> <input class="form-control" id="userName" name="USERNAME" type="text" placeholder="이름을 입력해 주세요">
				</div>
				<div class="form-group">
